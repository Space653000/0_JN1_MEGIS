...
> - 目前內容：UX-0／G0／G1／G2／G3／G4 驗收基線與 V3C 追溯審查結果；G4 全數閉合並以 `SO-0005`（E4）accepted、G5 active（2026-09-22）。
...
| G5 | active | G5-PKG-001 in_progress | G5 — 原型套件與可重現性：manifest 與 content hashes 施工中 |
