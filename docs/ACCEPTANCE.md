...
| G3 | active | G3-RUL-001、G3-SRC-001 已閉合；G3-VAL-001 施工中 | 規則／驗證 gate：`rule schema / governance / waiver`（G3-RUL-001）與來源登錄（G3-SRC-001）已閉合，`G3-VAL-001` geometry / collision / clearance validators 進行中 |
