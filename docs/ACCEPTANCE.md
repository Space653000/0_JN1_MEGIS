...
> - 最後審查 commit：`efd8021f398b55598997e5ce6ceb9d1736d3b599`
...
| G3 | active | G3-RUL-001、G3-SRC-001、G3-VAL-001、G3-VAL-002 已閉合；G3-MAT-001 施工中 | 規則／驗證 gate：`rule schema / governance / waiver`、來源登錄、geometry/collision/clearance validators 與 CNC DFM rule pack 已閉合，`G3-MAT-001` maturity evaluator 進行中 |
