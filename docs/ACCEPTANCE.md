...
> - 最後審查 commit：`43f2e0f32a695c61c76efd39a2c02bddd572fab8`
...
| G3 | active | G3-RUL-001、G3-SRC-001、G3-VAL-001 已閉合；G3-VAL-002 施工中 | 規則／驗證 gate：`rule schema / governance / waiver`、來源登錄與 geometry/collision/clearance validators 已閉合，`G3-VAL-002` CNC DFM rule pack 進行中 |
