...
> - 目前內容：UX-0／G0～G5 驗收基線與 V3C 追溯審查結果；G5 以 `SO-0006`（E4）accepted、G6 active；G6-UI-002 已以真實 HTTP／React／瀏覽器 byte-equivalence E3 證據閉合，G6-A11Y-001 in_progress。
...
| G6 | active | G6-UI-001（`7870b41`）、G6-QST-001（`9c1c671`）、G6-AI-001～004 與 G6-UI-002（`9d3278c`）已閉合（E3） | G6-A11Y-001 正針對新 UI 重跑；真人抽查 pending；G6 尚未 Gate acceptance |
