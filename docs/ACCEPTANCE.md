...
- V3.0 盤點（2026-09-23，G6-A11Y-001 驗收引導）：`/progress` 展開區分別列出支援證據、下一步 verifier 指令與 acceptance 狀態；新增控制面規則，唯一 in-progress 工項若沒有證據或驗證指令即失效。597 Python + 22 Frontend、axe、lint、typecheck、build 全綠；人工紀錄仍 pending，62 done／1 in progress／11 planned 不變。
