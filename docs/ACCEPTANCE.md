...
> - 目前內容：UX-0／G0／G1／G2／G3 驗收基線與 V3C 追溯審查結果；G4-MOD-001、G4-GRF-001、G4-MOD-002、G4-IMP-001 與 G4-REV-001 已閉合、G4-ACC-001 待簽核（2026-09-22）。
...
| G4 | active | G4-MOD-001、G4-GRF-001、G4-MOD-002、G4-IMP-001、G4-REV-001 已閉合（E3）；G4-ACC-001 待簽核 | G4 進行中：module composition、安全 STEP／DXF 解析與自我審查均已閉合，下一工項 G4 acceptance 決策紀錄 |
...
- V3.0 盤點（2026-09-22）：G0～G3 全數 accepted；G4-MOD-001、G4-GRF-001、G4-MOD-002、G4-IMP-001 與 G4-REV-001 已閉合（G4-REV-001 審查 @ `eef0afc`）、G4-ACC-001 待簽核；G5～G9 planned。
