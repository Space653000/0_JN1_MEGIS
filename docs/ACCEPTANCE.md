...
> - 目前內容：UX-0／G0／G1／G2／G3 驗收基線與 V3C 追溯審查結果；G4 施工中（2026-09-22）。
> - Owner：MEGIS Builder；使用者保有否決權
> - 最後審查 commit：`645b8141c7ce941197a2afec45bd3c1e4a54bb85`
...
| G4 | active | G4-MOD-001（Module capability levels）施工中 | G4 起點：模組能力分級、PCB／USB-C／M3 composition、安全 STEP／DXF 解析與 relationship vocabulary |
...
- V3.0 盤點（2026-09-22）：G0～G3 全數 accepted；G4 進行中；G5～G9 planned。
...
`645b8141c7ce941197a2afec45bd3c1e4a54bb85`
