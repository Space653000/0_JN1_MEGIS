...
const requiredEntries = [
  ...
  ["execution/schemas/g0-decisions.schema.json", "file", "V3C-DEC-001"],
  ["execution/schemas/v3-required-work-items.json", "file", null],
  ["execution/decisions", "directory", "V3C-DEC-001"],
  ["execution/decisions/g0-decisions.json", "file", "V3C-DEC-001"],
